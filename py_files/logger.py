...
info_handling = RotatingFileHandler('static/logging/info.log', maxBytes = 1000, backupCount = 1)
error_handling = RotatingFileHandler('static/logging/error.log', maxBytes = 1000, backupCount = 1)
